                        ...
                        <div className="relative rounded-[3rem] overflow-hidden bg-gradient-to-br from-primary-600 via-primary-700 to-indigo-800 p-12 md:p-20 text-center shadow-2xl">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                                    <a href="/contact" className="px-8 py-4 bg-white text-primary-700 rounded-2xl font-bold hover:bg-slate-100 transition-all shadow-xl shadow-black/20 scale-100 hover:scale-105">
                                        Contact Our Experts
                                    </a>
                                    <a href="/blog" className="px-8 py-4 bg-primary-500/30 border border-white/30 text-white rounded-2xl font-bold hover:bg-white/10 transition-all backdrop-blur-sm">
