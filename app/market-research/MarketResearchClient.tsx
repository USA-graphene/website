                        ...
                        <div className="relative rounded-[3rem] overflow-hidden bg-gradient-to-br from-primary-600 via-primary-700 to-indigo-800 p-12 md:p-20 text-center shadow-2xl">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                                    <a href="/market-research-2026.html" download className="px-8 py-4 bg-white text-primary-700 rounded-2xl font-bold hover:bg-slate-100 transition-all shadow-xl shadow-black/20 scale-100 hover:scale-105 flex items-center justify-center gap-2">
