...
const nextConfig = {
  ...
  async headers() {
    return [
      ...
      // Prevent Google from indexing Next.js static asset chunk files (which causes GSC errors)
      {
  ...
  async redirects() {
    return [
      // NOTE: /contact-us/ is intentionally NOT listed here. It renders as a
      // crawlable alias page so Google Search Console does not classify it as
      // "Page with redirect".
      ...
      { source: '/supercapacitors-vs-batteries-the-ultimate-energy-showdown-or-a-dream-partnership', destination: '/blog/supercapacitors-vs-batteries-the-ultimate-energy-showdown-or-smart-partnership/', permanent: true },
      ...
      { source: '/blog/graphene-textiles-for-smart-clothing/', destination: '/blog/', permanent: true },
      { source: '/blog/graphene-textiles-for-smart-clothing', destination: '/blog/', permanent: true },
