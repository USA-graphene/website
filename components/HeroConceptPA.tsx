...
// Process-Academy-style: light background, bold organic shapes, large illustration,
// chunky rounded typography, strong color accent blob, scattered decorative elements.
// Adapted: cream/white bg + electric blue accent blob (not yellow) + graphene machine illustration
...
export default function HeroConceptPA() {
  return (
